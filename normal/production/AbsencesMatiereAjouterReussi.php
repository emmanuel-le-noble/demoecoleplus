                    ...
                    <div class="x_panel">
                        <div class="x_title">
							...
							<span style="color:#fff;font-weight:bold;font-size:18px;">
								Vos absences sont bien enregistr&eacute;es. Veuillez les consulter avant de continuer.</span>
							</div>
                        </div>
					    <div class="x_content">
						<div class="clearfix"></div>
						    <div><span style="font-family:comic sans ms;color:#000;font-weight:normal;">::: Information(s) :::</span></div>
							<br/>
						    <table width="100%">
								<tr>
									<td width="33%"> 
								...
								<tr>
									...
									<td width="33%"> 
										<div class="item form-group">
											<label class="control-label col-md-12 col-sm-12 col-xs-12" style="text-align:left;">
												Date d'op&eacute;ration : <?php echo $Coef;?>
											</label>
										</div>
									</td>
									<td width="33%"> 
							...
							<div><?php ListeNotesEleveAfterAdd($idsalle,$idposition,$idanneescolaire,$idmatiere,$pdo);?></div>					
					    </div>
