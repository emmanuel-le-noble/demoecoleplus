...
<html lang="en">
    ...
    /* Exemple si tu veux plusieurs couleurs par section */
    .color1 { background-color: #e6f7ff; } /* bleu pâle */
    .color2 { background-color: #fff0f5; } /* rose pâle */
    .color3 { background-color: #f5fff0; } /* vert pâle */
</style>
    </head>
    <body class="nav-md">
            ...
            <div class="main_container">
				<form method="post" action="">
					...
					<div class="left_col" role="main">
						<?php 	
							include('NiveauStockContenu.php');
						?>
					</div>    
				</form>
            </div>
