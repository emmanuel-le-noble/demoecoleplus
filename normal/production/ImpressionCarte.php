	...
	if(isset($_POST["CreerNumero"]))
	{
		...
		{		
			if(isset($_REQUEST["id".$i]))
			{
				...
				$numerotable = genererNumeroTable($codeposition, $idelevesalle);
				$numeroanonymat = genererNumeroAnonymat($codeposition, $idelevesalle);
            ...
            <div class="main_container">
				<form class="form-horizontal form-label-left" method="post" action="">
					...
					<div class="left_col" role="main">
						<?php include('ImpressionCarteContenu.php');?>
					</div>    
				</form>
            </div>
        </div>
