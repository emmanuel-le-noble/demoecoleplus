						    ...
						    <div class="x_content">
							    <div>							    
									...
									<hr style="border:1px dotted #000;"/>
										...
										<button type="button" class="btn btn-round btn-success" onclick='window.open("AnalyseResultatEdition.php?&idclasse=<?php echo $idclasse;?>&idanneescolaire=<?php echo $idanneescolaire;?>&idposition=<?php echo $idposition;?>","", "fullscreen=yes, scrollbars=auto");'>
											<i class="fa fa-print"></i>&nbsp;Imprimer la fiche
										</button>
										<?php AnalyseResultat($idanneescolaire,$idposition,$idclasse,$pdo);?>
									<hr style="border:1px dotted #000;"/>
								</div>
							</div>
					    </div>
