					    ...
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold">
						        	Donn&eacute;es de paie des enseignants
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les donn&eacute;es de paie du corps enseignant]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									<div style="margin-bottom:25px;">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Desactiver" value="Desactiver" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir d&eacute;sactiver cet employ&eacute; ?');"/>
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-warning" name="Annuler" value="Annuler" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir annuler la d&eacute;sactivation de cet employ&eacute; ?');"/>
										&nbsp;
									</div>
									<?php 
										if($error!="")
