                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel" style="box-shadow:8px 8px 0px #aaa;">
						...
						<div class="clearfix"></div>
							...
							[ Veuillez renseigner les information(s) pour la cr&eacute;ation des trimestres et des examens ]</span></div>
							...
							<div align="center" class="col-md-6 col-md-offset-3">
								...
								<input id="send" type="submit" class="btn btn-round btn-success" name="EnregistrerTrimestreExamen" value="Enregistrer"/> 
							</div>
					    </div>
                    </div>
                </div>
