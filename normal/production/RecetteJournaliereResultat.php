					...
					<div class="x_panel" style="box-shadow:8px 8px 0px #aaa;">
						...
						<div class="x_content">
							<div>									
								...
								[ Veuillez renseigner les information(s) pour avoir la recette ]</span></div><br/>
								<table width="100%" align="center">
									<tr>
										<td width="33%">
											<div class="form-group">
												<label class="control-label col-md-5 col-sm-5 col-xs-12" style="text-align:left;">Date d&eacute;but (journ&eacute;e)<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker3' class="col-md-6 col-sm-6 col-xs-12">
										...
										<td width="33%">
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker4' class="col-md-6 col-sm-6 col-xs-12">
								...
								<div>
									<label class="control-label col-md-12 col-sm-12 col-xs-12" style="text-align:left;font-weight:bold;font-family:comic sans ms;font-size:16px;color:#000;">
										[ Recette des paiements & ventes effectu&eacute;es du : <?php echo $DateDebut;?> au <?php echo $DateFin;?>&nbsp;]
									</label>
									<br/><br/><br/>
