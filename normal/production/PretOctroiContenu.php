					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;">
									...
									<small style="color:#000;font-weight:bold">
										[Permet de g&eacute;rer les prêts effectu&eacute;s au personnel]
									</small>
								</h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div>							    
									<div>
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer ce dossier de prêt ?');"/>
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-default" name="Consulter" value="Consulter"/>
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-warning" name="VoirTableauAmortissement" value="Voir TA"/>
										&nbsp;
									</div><br/>
									<?php 
									if($error!="")
