					    ...
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;">
						        	Notes du cycle sup&eacute;rieur
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les notes des diff&eacute;rentes &eacute;valuations r&eacute;alis&eacute;es]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="Note">									
									<div style="margin-bottom:25px;"><span style="color:#000;font-weight:bold;font-size:14px;text-shadow: 0px 0px 4px rgba(0,0,0,0.75);font-family:comic sans ms">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer cette note ?');"/>
										&nbsp;
									</div>									
									<?php 
										if($_SESSION['titreprof']==2 OR $_SESSION['titreprof']==3 OR $_SESSION['titreprof']==4)
										{
											SyntheseNotesProf($_SESSION['iduser'],$pdo);
										}
										else
										{
											SyntheseNotesCycleSup($pdo);
										}
									?>
								</div>
							</div>
