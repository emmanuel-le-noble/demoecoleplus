					    ...
					    <div class="x_panel" style="background-color: #E9F2DF;box-shadow: 8px 8px 0px #aaa;">
						    ...
						    <div class="x_content">
							    <div>	
										...
										<tr>
											<td>
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<?php getAllSalleSelected_3($idSalle,$pdo);?>
													</div>
												</div>
											</td>
											<td>
											...
											<td>
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<?php getEleveStatutClasseSelected_2($idEleveStatutClasse,$pdo);?>
													</div>
												</div>
											</td>
											<td>
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<?php getEleveStatutEtablissementSelected_2($idEleveStatutEtablissement,$pdo);;?>
													</div>
												</div>
											</td>
										</tr>
									...
									<hr style="border:1px dotted #000;"/>
									<div style="background-color: #E9F2DF;padding:10px 10px 40px 10px;">
										<label class="control-label col-md-8 col-sm-8 col-xs-12" 
										style="text-align:left;font-weight:bold;color:red;font-family:comic sans ms;font-size:15px;">
										<i>[ R&eacute;sultat de la liste recherch&eacute;e ]</i></label><br/><br/><br/>
										<?php DossierEleveParClasse($idAnneeScolaire,$idClasse,$idSalle,$sexe,$idEleveStatutClasse,$idEleveStatutEtablissement,$pdo);?>
									</div>
								</div>
							</div>
					    </div>
