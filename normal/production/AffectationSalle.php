<?php 
	...
	$error="";
	$success="";
	if(isset($_REQUEST["EnregistrerAffectation"]))
	{ 
		...
		{		
			if(isset($_REQUEST["id".$i]))
			{
				...
				CreateEleveSalle($id,$idsalle,1,$pdo);
			}
		}
	}
	elseif(isset($_REQUEST["SupprimerAffectation"]))
	{ 
		...
		{		
			if(isset($_REQUEST["id".$i]))
			{
				$id = trim($_REQUEST["id".$i]);	
				$statut=-1;
				DeleteEleveSalle($id,$statut,$pdo);
			}
		}
	}
?>
				...
				<form class="form-horizontal form-label-left" method="post" action="">
					...
					<div class="left_col" role="main">
						<?php  
							...
							{
								include('AffectationSalleAjouter.php');								
							}
							else
							{
								include('AffectationSalleContenu.php');
							}
						?>
					</div>    
				</form>  
