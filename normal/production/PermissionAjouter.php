                    ...
                    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
						...
						<div class="clearfix"></div>
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="date" class="form-control" name="datedemande" required="required"/>
											</div>
										</div>
									</td>
									<td>
							...
							<div align="center" class="col-md-6 col-md-offset-3">
								...
								<input id="send" type="submit" class="btn btn-round btn-success" name="EnregistrerPermission" value="Enregistrer"/> 
							</div>
					    </div>
                    </div>
                </div>
