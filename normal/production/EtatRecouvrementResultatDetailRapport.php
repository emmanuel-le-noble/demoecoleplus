	...
	<div style="padding:10px;">
		<div>
			...
			<h1 style="color:#000;font-weight:bold;font-size:16px;text-shadow: 0px 0px 4px rgba(0,0,0,0.75);font-family:comic sans ms;text-align:center;">
				[ ETAT DE RECOUVREMENT PAR CLASSE]
			</h1>
		</div><br/>
		<table width="100%" align="center">
			<tr>
				<td width="30%" style="text-align:center;color:#000;font-family:comic sans ms;">
					Type de frais : <?php echo $paiementtypelibelle;?>
				</td>
				<td width="35%" style="text-align:center;color:#000;font-family:comic sans ms;">
