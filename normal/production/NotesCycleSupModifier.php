                    ...
                    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
                        <div class="x_title">
							<h1 style="font-family:comic sans ms;font-weight:bold;color:#000;">
						        Modifier les notes pour le cycle sup&eacute;rieur
						    </h1>
							<div class="clearfix"></div>
                        </div>
					    <div class="x_content">
						    ...
						    <table width="100%">
									...
									<td width="33%"> 
										<div class="item form-group">
											<label class="control-label col-md-12 col-sm-12 col-xs-12" style="text-align:left;">
												&Eacute;valuation : <?php echo $LibellePosition;?>
											</label>
										</div>
									</td>
									<td width="33%"> 
								...
								<tr>
									<td width="33%"> 
										<div class="item form-group">
											<label class="control-label col-md-12 col-sm-12 col-xs-12" style="text-align:left;">
												<span class="btn btn-info btn-xs"> Mati&egrave;re : <?php echo $CodeMatiere;?> </span>
											</label>
										</div>
									</td>
									<td width="33%"> 
