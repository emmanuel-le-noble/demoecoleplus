                ...
                <div class="col-md-9 col-xs-12">
                    <div class="x_panel">
						...
						<div class="clearfix"></div>
						    ...
						    [ Information(s) sur l'&eacute;valutation ]</span></div>
						    <table width="100%">
								<tr>
									<td width="33%"> 
										<div class="item form-group">
											<label class="control-label col-md-10 col-sm-10 col-xs-12" style="text-align:left;">&Eacute;valuation : <?php echo $libelleposition;?></label>
										</div>
									</td>
									<td width="33%"> 
										<div class="item form-group">
							...
							<div style="margin-bottom:5px;"><span style="font-family:comic sans ms;color:#000;font-weight:bold">::: Choisissez la mati&egrave;re pour mettre les notes associ&eacute;es :::</span></div>
							<table width="100%" style="margin-bottom:5px;">
								<tr>
									<td width="33%"> 
										<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:left;">
											Mati&egrave;re<span class="required">&nbsp;&nbsp;<font color="red">*</font></span>
										</label>
