...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .left h2{margin:.2rem 0; font-size:9px; text-transform:uppercase;}
    .left .bloc{font-size:9px; color:var(--primary)}
	...
	.Cadre_corps th[colspan="14"] {
	  ...
	  background: #e0f7fa;     /* optionnel : mettre un fond distinct */
		...
		<table class="Cadre_corps">
		  ...
		  <tbody>
			...
			<tr>
				...
				<td>&nbsp;<?php echo BulletinAppreciation($idanneescolaire,$idposition,$idsalle,$idelevesalle,36,$pdo);?></td>
				<td><?php echo BulletinProfesseur($idanneescolaire,$idposition,$idsalle,$idelevesalle,36,$pdo);?></td>
				<td>&nbsp;<?php echo BulletinSignature($idanneescolaire,$idposition,$idsalle,$idelevesalle,36,$pdo);?></td>
			</tr>
			<tr>
				<td colspan="7" align="right"><b>Total</b></td>
				<td class="num">
			...
			<tr>
				...
				<td colspan="3"><b>Moy (4) : <?php if($TotalCoef_4!=0) echo round(($Totalmoy_4/$TotalCoef_4),2);?> ; Point obtenu : <?php if($TotalCoef_4!=0) echo prendreSiSuperieurA10(round(($Totalmoy_4/$TotalCoef_4)));?></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td valign="top">
				   <table>
					<tr>
							...
							if($idposition==1)
							{
								...
								<table width="100%" class="Cadre_haut">
									<tr>
										...
										<td><b><?php echo round(trim(getMoyenneTrimestre_1($idanneescolaire,$idsalle,$ideleve,$pdo)),2);?></b></td>
									</tr>
									<tr>
										<td><b></b></td>
										<td><b></b></td>
							...
							elseif($idposition==2)
							{
								...
								<table width="100%" class="Cadre_haut">
									...
									<tr>
										...
										<td><b><?php echo round(trim(getMoyenneTrimestre_2($idanneescolaire,$idsalle,$ideleve,$pdo)),2);?></b></td>
									</tr>
									<tr>
										<td><b></b></td>
										<td><b></b></td>
							...
							elseif($idposition==3)
							{
								...
								<table width="100%" class="Cadre_haut">
									...
									<tr>
										...
										<td><b><?php echo round(trim(getMoyenneTrimestre_3($idanneescolaire,$idsalle,$ideleve,$pdo)),2);?></b></td>
									</tr>
									<tr>
										<td><b>Moy. annuelle</b></td>
										<td><b><?php echo round(getMoyAnnu($idanneescolaire,$idsalle,$ideleve,$pdo),2);?></b></td>
									</tr>
									<tr>
										<td><b>Rang annuel</b></td>
										<td><b><?php echo getRangAnnu($idanneescolaire,$idsalle,$ideleve,$pdo);?></b></td>
									</tr>
								</table>
								<?php
							}
						...
						<td style="padding:2mm;" valign="top">
							<table>
								...
								<tr>
									<td colspan="2"><div style="margin-left:auto" class="tiny">Retards : <b> </b> &nbsp;&nbsp; Absences : <b> <?php echo getNbreAbsenceForAnneescolaire($ideleve,$idposition,$idanneescolaire,$pdo);?></b></div></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<div style="text-align:left;padding:2px;padding-top:5px;"><b>Observations et décision du conseil</b></div>
							<br/>
							<div class="panel" style="padding-bottom:5mm;border:1px solid #000;">
								<div>
									<span>
									<?php 
