				...
				<form class="form-horizontal form-label-left" method="post" action="">
					...
					<div class="left_col" role="main">
						<?php 
							...
							elseif(isset($_POST["AjouterAbsencesEleve"]))
							{
								...
								{		
									if(isset($_REQUEST["id".$i]))
									{
										...
										$nbreabsence = trim($_REQUEST["nbreabsence".$i]);
			                            if($nbreabsence!="")
                                        {		
											CreateAbsences($idelevesalle,$nbreabsence,$idposition,$idsalle,$idanneescolaire,$_SESSION['iduser'],$pdo);
                                        }											
									}
								}
								include('AbsencesAjouterReussi.php');
							}	
							elseif(isset($_POST["suivantAbsences"]))
							{
								...
								include('AbsencesAjouterSuivant.php');									
							}							
