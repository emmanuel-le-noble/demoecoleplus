				...
				<form class="form-horizontal form-label-left" method="post" action="">
					...
					<div class="left_col" role="main">
						<?php
							...
							{
								$id="";
							    $nbreeffectifclasse = trim($_POST["nbreeffectifclasse"]);
								for($i=1;$i<=$nbreeffectifclasse;$i++)
								{		
									if(isset($_POST["id".$i]))
									{
										$id = trim($_POST["id".$i]);
								...
								if($id!="")
								{
									include('EffectifClasseModifier.php');
								}
								else
								{
									$error="Veuiller s&eacute;lectionner la classe &agrave; consulter.";
									include('EffectifClasseContenu.php');
								}
							}
							else
							{
