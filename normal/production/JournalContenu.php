					    ...
					    <div class="x_panel" style="background-color:#E9F2DF;box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:red;">
						        	...
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les &eacute;venements effectu&eacute;s sur le syst&egrave;me]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									...
									if($error!="")
								    {
										?><div class="alert alert-warning alert-dismissible fade in" role="alert" style="width:100%;padding:5px;"><b><?php echo $error;?></b></div><?php
                                    }
                                    elseif($success!="")
                                    {
