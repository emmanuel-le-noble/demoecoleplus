					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:red;">
						        	...
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les utilisateurs]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									<div style="margin-bottom:25px;">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="D&eacute;sactiver" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir d&eacute;sactiver ce(s) utilisateur(s) ?');"/>
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-warning" name="Activer" value="Activer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir Activer ce(s) utilisateur(s) ?');"/>
										&nbsp;
									</div>
									<?php 
									if($error!="")
