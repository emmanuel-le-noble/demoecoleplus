					    ...
					    <div class="x_panel">
						    ...
						    <div class="x_content">
								<div>									
										...
										<tr>
											<td width="33%">
												<div class="form-group">
													...
													Ann&eacute;e sc.<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
									...
									<hr style="border:1px dotted #000;"/>	
									<div>
										<span style="text-align:left;color:#000;font-weight:bold;font-size:16px;">
											[&nbsp;R&eacute;sultat de la synthèse]
										</span>
									</div><br/>	
									<?php 
										EvaluationClasse($libelleanneescolaire,$idanneescolaire,$idposition,$iddomaine,$moyenne,$pdo);
									?>
								</div>
							</div>
					    </div>
