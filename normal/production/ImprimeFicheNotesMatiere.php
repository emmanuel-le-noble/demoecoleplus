<?php
	...
	$position = getLibellePosition($idposition,$pdo);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="background-color:#fff;">
	<div>
		...
		<center><h2> FICHE DE NOTES </h2></center>
		<table width="100%" align="center">
			<tr>
				...
				<td width="35%">
					EVALUATION : <b><?php echo $position;?></b>
				</td>
				<td width="35%">
			...
			<tr>
				...
				<td colspan="2">
					Chargé du cours : <b><?php echo $nom;?></b>
				</td>
			</tr>
		</table>
		<hr style="border:1px dotted #000;"/>
		<?php ImprimeFicheNotesMatiere($idsalle,$idanneescolaire,$idposition,$idmatiere,$pdo);?>
		<hr style="border:1px dotted #000;"/>
