                    ...
                    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
                        <div class="x_title">
							<h1 style="font-family:comic sans ms;font-weight:bold;color:#000;">
						        Modifier le dossier de l'&eacute;l&egrave;ve [ Matricule ] : <font color='#ff0000'><?php echo $matricule;?></font>
						    </h1>
							<div class="clearfix"></div>
                        </div>
					    <div class="x_content">
						<div class="clearfix"></div>
							...
							[ Veuillez mettre &agrave; jour les information(s) de l'&eacute;l&egrave;ve ]</span></div>
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
											  <input type="text" name="prenom_eleve" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $prenom_eleve;?>"/>
											</div>
										</div>
									</td>
								</tr>
							...
							<tr>
								<td>
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:left;">Email. du tuteur</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="email" class="form-control"  name="emailtuteur" value="<?php echo $mailtuteur;?>"/>
										</div>
									</div>
								</td>
								<td>
							...
							<tr>
								<td colspan="2">
									<div class="form-group">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<button type="button" class="btn btn-sm btn-info btn-invitation" data-id="<?php echo $id_eleve;?>">
												<i class="fa fa-envelope"></i> Renvoyer l'invitation portail parent
											</button>
											<span id="invitation-result-<?php echo $id_eleve;?>" style="margin-left:10px;"></span>
										</div>
									</div>
								</td>
							</tr>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="number" class="form-control" id="remise" name="remise" value="<?php echo $boursier;?>"/>
											</div>
										</div>
									</td>
								</tr>
