				...
				<form id="my_form" class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
					...
					<?php 							
						if(isset($_POST["genererBulletins"]))
						{
							...
							include('DuplicataGeneration.php');
						}
						elseif(isset($_REQUEST["DetailDuplicata"]))
						{ 
							...
							if($valeur!=0)
							{
								include('BulletinsDuplicata.php');
							}
							else
							{
								include('BulletinsDuplicata.php');
						...
						elseif(isset($_POST["AjouterDuplicata"]))
						{
							include('GenererDuplicata.php');									
						}
						else
						{
							include('DuplicataContenu.php');
						}
					?>
					</div>    
				</form>
