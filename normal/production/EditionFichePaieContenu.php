					    ...
					    <div class="x_panel" style="background-color: #E9F2DF;box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:red;">
						        	Edition de fiche(s) de paie
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les fiches de paie de l'ann&eacute;e scolaire]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="FichePaie">									
									<div style="margin-bottom:10px;">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer ce mois de paie ?');"/>
										&nbsp;
									</div>
									<?php 
										if($error!="")
