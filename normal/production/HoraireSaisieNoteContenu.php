					    ...
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;">
						        	Horaire de saisie des notes
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les horaires de saisie des notes des professeurs
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									<div style="margin-bottom:10px;">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer cette horaire ?');"/>
										&nbsp;
									</div>
									<?php 
										if($error!="")
	                                    ...
	                                    elseif($success!="")
	                                    {
											...
											<div class="alert alert-success alert-dismissible fade in" role="alert" style="width:100%;padding:5px;border:1px solid #A2C600;">
												<b><?php echo $success;?></b></div>
											<?php
	                                    }
										ListHoraireSaisieNote($pdo);
									?>
								</div>
							</div>
					    </div>
