											...
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker9' class="col-md-6 col-sm-6 col-xs-12">
														<input type='text' class="form-control" name="datedebut" autocomplete="off" required="required"/>
											...
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker10' class="col-md-6 col-sm-6 col-xs-12">
														<input type='text' class="form-control" name="datefin" autocomplete="off" required="required"/>
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
													</div>
