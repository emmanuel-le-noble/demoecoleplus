							...
							<div>									
											...
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker3' class="col-md-6 col-sm-6 col-xs-12">
														<input type='text' class="form-control" name="DateDebut" autocomplete="off"/>
											...
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<div class='input-group date' id='myDatepicker4' class="col-md-6 col-sm-6 col-xs-12">
														<input type='text' class="form-control" name="DateFin" autocomplete="off"/>
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
													</div>
								...
								<div class="row">
									<div class="col-xs-12 invoice-header">
										<h1>
											<i class="fa fa-globe"></i> Historique des journ&eacute;es clotur&eacute;es
										</h1>
									</div>
									<!-- /.col -->
								 </div>
