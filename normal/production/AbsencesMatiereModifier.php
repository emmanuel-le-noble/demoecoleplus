            ...
            <div class="row">
                <div class="col-md-9 col-xs-12">
                    <div class="x_panel" style="background-color: #E9F2DF;box-shadow: 8px 8px 0px #aaa;">
					    ...
					    <div class="x_content">
						<div class="clearfix"></div>
						    <div><span style="font-family:comic sans ms;color:#000;font-weight:bold;">::: Information(s) :::</span></div>
							<br/>
						    <table width="100%">
								<tr>
									<td width="33%"> 
							...
							<div><span style="font-family:comic sans ms;color:#000;font-weight:bold;">::: La liste des &eacute;l&egrave;ves :::</span></div>
							<br/>
							<div><?php ListEleveSalle($idsalle,$idposition,$idanneescolaire,$idmatiere,$pdo);?></div>
							<hr/>
