					...
					<div class="left_col" role="main">
						<?php
							if(isset($_POST["Detail"]))
							{
								...
								$nbreetatrecouvrement = $_REQUEST['nbreetatrecouvrement'];
								$id="";
								for($i=1;$i<=$nbreetatrecouvrement;$i++)
								{		
								...
								if($id!="")
								{
									include('EtatRecouvrementResultatDetail.php');
								}
								else
								{
									$idpaiementtype = trim($_REQUEST["idPaiementType"]);
									$paiementtypelibelle = getlibelletypepaiement($idpaiementtype,$pdo);
									$idanneescolaire = trim($_REQUEST["idanneescolaire"]);
									$libelleanneescolaire = getLibelleAnneeScolaire($idanneescolaire,$pdo);
								
									include('EtatRecouvrementResultat.php');
								}									
							}
							elseif(isset($_REQUEST["AfficherSituation"]))
							{
								...
								//
								include('SituationPaiementResultat.php');
							}
							else
							{
								include('SituationPaiementContenu.php');
							}
						?>
					</div>    
				</form>
