					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold">
						        	...
						        	<small style="color:#000;font-weight:bold;">
										[Permet de cr&eacute;er le personnel permanent]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									<div style="margin-bottom:25px;">
										...
										&nbsp;
										<input type="submit" style="width:100px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Desactiver" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir Desactiver cet employ&eacute; ?');"/>
										&nbsp;
									</div>
									<?php 
										if($error!="")
