                    ...
                    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
                        <div class="x_title">
                        	<h1 style="font-family:comic sans ms;font-weight:bold;color:#000;">
						        Cr&eacute;er une nouvelle Classe/Fili&egrave;re
						    </h1>
							<div class="clearfix"></div>
                        </div>
					    <div class="x_content">
						<div class="clearfix"></div>
							...
							[ Veuillez renseigner les information(s) pour la cr&eacute;ation de la Classe/Fili&egrave;re ]</span></div>
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
											    <input type="text" name="codesalle" required="required" class="form-control col-md-7 col-xs-12"/>
											</div>
										</div>
									</td>
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" name="nomsalle" required="required" class="form-control col-md-7 col-xs-12"/>
											</div>
										</div>
									</td>
								</tr>
							...
							<div align="center" class="col-md-6 col-md-offset-3">
								...
								<input id="send" type="submit" class="btn btn-round btn-success" name="EnregistrerSalle" value="Enregistrer"/> 
							</div>
					    </div>
                    </div>
                </div>
