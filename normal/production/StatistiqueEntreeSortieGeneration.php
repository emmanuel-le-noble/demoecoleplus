				    ...
				    <div class="col-md-12">
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
						    ...
						    <div class="x_content">						    
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class='col-sm-6'>
													<input type='date' class="form-control" name="datedebut" autocomplete="off" required="required" value="<?php echo $_POST["datedebut"];?>"/>
												</div>
											</div>
										</td>
										<td>
									...
									<tr>
										<td width="50%">
											<span style="color:#000;font-weight:bold;font-size:16px;font-family:comic sans ms">
												[ R&eacute;sultat de la statistique des entr&eacute;s/sorties effectu&eacute;es ]
											</span>
										</td>
										<td width="50%">
											<div style="float:right;">
												<a href="#" class="btn btn-warning btn-xs" onclick='window.open("StatistiqueEntreeSortieRapport.php?&idanneescolaire=<?php echo $idanneescolaire;?>&idcompte=<?php echo $idcompte;?>&datedebut=<?php echo $_POST["datedebut"];?>&datefin=<?php echo $_POST["datefin"];?>","new","width=1366px, height=700px, top=300, left=500, location=500, directories=0, personnalbar=0, toolbar=no");'>
								...
								<?php ListeEntreeSortie($datedebut,$datefin,$idanneescolaire,$idcompte,$pdo);?>
							</div>
					    </div>
				    </div>
				</div>
