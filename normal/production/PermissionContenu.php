					    ...
					    <div class="x_panel" style="background-color: #E9F2DF;box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold">
						        	Permission des enseignants
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les permissions des enseignants au cours de l'ann&eacute;e scolaire]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="Permission">									
									<div style="margin-bottom:25px;">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer ce(s) permission(s) ?');"/>
										&nbsp;
									</div>									
									<?php ListePermissions($pdo);?>
								</div>
							</div>
					    </div>
				    </div>
