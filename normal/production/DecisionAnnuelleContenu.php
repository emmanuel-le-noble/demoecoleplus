					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:red;">
						        	...
						        	<small style="color:#000;font-weight:bold;">
										[Permet de g&eacute;rer les statistiques d'&eacute;valuation]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
							    ...
							    <div>									
									...
									<table width="100%" align="center">
										...
										<tr>
											...
											<td>
												<div class="item form-group">
													<label class="control-label col-md-6 col-sm-6 col-xs-12" style="text-align:right;">Moyenne<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
													<div class="col-md-6 col-sm-6 col-xs-12">
