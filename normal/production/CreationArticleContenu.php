					    ...
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;">
						        	Cr&eacute;ation des articles
						        	<small style="color:#000;font-weight:bold;">
										[ Permet de cr&eacute;er les articles ]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="">
									<div>
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir suppimer ce(s) article(s) ?');"/>
										&nbsp;
									</div><br/>
									<?php 
										if($error!="")
