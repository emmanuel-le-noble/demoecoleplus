					    ...
					    <div class="x_panel" style="box-shadow:8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold">
						        	Paiement des frais <small style="color:#000;font-weight:bold">[Permet de g&eacute;rer tous les paiements des frais de scolarit&eacute;]</small></h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div id="PaiementFrais">							    
									<div><span style="color:#000;font-weight:bold;font-size:14px;text-shadow: 0px 0px 4px rgba(0,0,0,0.75);font-family:comic sans ms">
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer ce(s) paiement(s) ?');"/>
										&nbsp;
									...
									ListePaiementFrais($_SESSION['idanneescolaire'],$pdo);?>
								</div>
							</div>
					    </div>
				    </div>
