                    ...
                    <div class="x_panel">
						...
						<div class="clearfix"></div>
							...
							if($corps==1)
							{
								...
								<div><span style="color:#000;font-weight:bold;font-size:16px;font-family:comic sans ms">
								[ Veuillez saisir les nombres d'heures effectu&eacute;es ]</span></div><br/>
								<table width="100%">
									<tr>
										<td> 
											<?php ListCorpsProfessorat($idanneescolaire,$pdo);?>
										</td>
									</tr>
								</table>
								<hr style="border:1px dotted #000;margin-top:0px;margin-bottom:5px;"/><br/>
							...
							else
							{
								...
								[ Veuillez passer au traitement des donn&eacute;es ]</span></div>
								<br/>
								<table width="100%">
									<tr>
										<td> 
											<?php ListCorpsAdministratif($pdo);?>
										</td>
									</tr>
								</table>
								<hr style="border:1px dotted #000;margin-top:0px;margin-bottom:5px;"/><br/>
