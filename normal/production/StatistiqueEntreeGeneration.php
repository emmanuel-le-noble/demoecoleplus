					    ...
					    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:#000;">
						        	Statistique sur les entr&eacute;es de fonds
						        	<small style="color:#000;font-weight:bold;">
										[ Permet d'avoir les entr&eacute;es sur une p&eacute;riode ]
									</small>
						        </h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">						    
									...
									<tr>
										<td width="50%">
											<span style="color:#000;font-weight:bold;font-size:16px;font-family:comic sans ms">
												[ R&eacute;sultat de la statistique des entr&eacute;es ]
											</span>
										</td>
										<td width="50%">
											<div style="float:right;">
												<a href="#" class="btn btn-warning btn-xs" onclick='window.open("StatistiqueEntreeRapport.php?&idanneescolaire=<?php echo $idanneescolaire;?>&idcompte=<?php echo $idcompte;?>&datedebut=<?php echo $_REQUEST["datedebut"];?>&datefin=<?php echo $_REQUEST["datefin"];?>","new","width=1366px, height=700px, top=300, left=500, location=500, directories=0, personnalbar=0, toolbar=no");'>
								...
								<?php ListeEntree($datedebut,$datefin,$idanneescolaire,$idcompte,$pdo);?>
							</div>
					    </div>
				    </div>
				</div>
