					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;color:red;">
									...
									<small style="color:#000;font-weight:bold">
										[ Permet de g&eacute;rer la tr&eacute;sorerie de l'&eacute;tablissement ]
									</small>
								</h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div>							    
									<div>
										...
										<input type="submit" style="width:150px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-success" name="Ajouter" value="Nouvelle op&eacute;ration"/>
										&nbsp;
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer cette op&eacute;ration ?');"/>
										&nbsp;
									</div><br/>
									<?php 
									if($error!="")
									...
									ListeEntreeSortie($_SESSION['idanneescolaire'],$pdo);?>
								</div>
							</div>
					    </div>
				    </div>
