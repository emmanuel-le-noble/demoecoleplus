										...
										<tr>
											<td width="33%">
												<div class="form-group">
													<label class="control-label col-md-4 col-sm-4 col-xs-12">Type de frais<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
											...
											<td width="33%">
												<div class="form-group">
													<label class="control-label col-md-4 col-sm-4 col-xs-12">Ann&eacute;e scolaire<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
													<div class="col-md-6 col-sm-6 col-xs-12">
