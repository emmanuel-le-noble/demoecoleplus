					        ...
					        <div class="x_title">
						        <h2 style="font-family:comic sans ms;font-weight:bold;">
									...
									<small style="color:#000;font-weight:bold">
										[Permet de g&eacute;rer les remboursements de prêts]
									</small>
								</h2>
						        <div class="clearfix"></div>
					        </div>
						    <div class="x_content">
							    <div>							    
									<div>
										...
										Les types d'op&eacute;ration &agrave; effectuer : </span>
										...
										&nbsp;
										<input type="submit" style="width:90px;padding:2px;box-shadow: 8px 8px 0px #aaa;" class="btn btn-round btn-danger" name="Supprimer" value="Supprimer" onclick="return confirm('&ecirc;tes-vous s&ucirc;r de vouloir supprimer ce remboursement ?');"/>
										&nbsp;
									</div><br/>
									<?php 
									if($error!="")
