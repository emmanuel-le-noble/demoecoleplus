...
<head>
    ...
    <body style="font-size:11px;background-color:#fff;">
	    <div>
			...
			<center><h2> LISTE DES ENTR&Eacute;ES/SORTIES EFFECTU&Eacute;ES </h2></center>
			...
			<?php ListeEntreeSortie(trim($_REQUEST["datedebut"]),trim($_REQUEST["datefin"]),$idanneescolaire,$idcompte,$pdo)?>  
			<hr style="border:1px dotted #000;"/>
