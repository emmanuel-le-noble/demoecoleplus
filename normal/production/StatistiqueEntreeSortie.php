            ...
            <div class="main_container">
				<form class="form-horizontal form-label-left" method="post" action="">
					...
					<?php 							
						...
						{
							$idanneescolaire = trim($_POST["idanneescolaire"]);
							$idcompte = trim($_POST["idcompte"]);
							$datedebut = trim($_POST["datedebut"]);
							$datefin = trim($_POST["datefin"]);
							
							include('StatistiqueEntreeSortieGeneration.php');
						}
						else
						{
							include('StatistiqueEntreeSortieContenu.php');
						}
					?>
					</div>    
				</form>
