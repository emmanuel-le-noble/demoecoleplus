        ...
        <div class="right_col" role="main">
            ...
            <div class="page-title">
				<div class="title_left">
					<h2>Administration - Evaluation - Ajouter</h2>
				</div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
							<h2><font color="red">Ajouter une &eacute;valuation</font></h2>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" class="form-control" data-inputmask="'mask': '99/99/9999'" name="date_evaluation"/>
				...
				<div align="center" class="col-md-6 col-md-offset-3">
					...
					<input id="send" type="submit" class="btn btn-success" name="enregistrer_evaluation" value="Enregistrer"/> 
				</div>
            </div>
        </div>
    </div>
