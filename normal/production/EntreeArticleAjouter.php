                    ...
                    <div class="x_panel" style="box-shadow: 8px 8px 0px #aaa;">
                        <div class="x_title">
							<h1 style="font-family:comic sans ms;font-weight: bold;color:#000;">
								Nouvelle entr&eacute;e d'articles en stock
							</h1>
							<div class="clearfix"></div>
                        </div>
					    <div class="x_content">
								...
								<tr>
									<td>
										<div class="form-group">
											<label class="control-label col-md-5 col-sm-5 col-xs-12" style="text-align:left;">Motif de l'entr&eacute;e
											<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
											<div class="col-md-7 col-sm-7 col-xs-6">
											  <input type="text" name="MotifEntree" required="required" class="form-control"/>
											</div>
										</div>
									</td>
									<td>
										<div class="form-group">
											<label class="control-label col-md-4 col-sm-4 col-xs-12" style="text-align:left;">Num. entr&eacute;e
											<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
											<div class="col-md-6 col-sm-6 col-xs-6">
											  <input type="text" name="NumEntree" required="required"  
											  class="form-control" value="ENTREE/<?php echo getNumArticleEntree($pdo);?>" 
									...
									<td>
										<div class="item form-group">
											...
											style="text-align:left;">Date entr&eacute;e
											<span class="required">&nbsp;&nbsp;<font color="red">*</font></span></label>
