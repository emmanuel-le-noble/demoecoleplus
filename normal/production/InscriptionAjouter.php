                    ...
                    <div class="x_panel" style="box-shadow:8px 8px 0px #aaa;">
                        <div class="x_title">
							<h1 style="font-family:comic sans ms;font-weight:bold;color:#000;">
						        Ajouter une nouvelle inscription [ Matricule ] : <font color='#ff0000'><?php echo $matricule;?></font>
						    </h1>
							<div class="clearfix"></div>
                        </div>
					    <div class="x_content">
						<div class="clearfix"></div>
							...
							<table width="100%">
								<tr>
									<td width="50%">
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:left;">Photo</label>
									...
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input class="form-control" type="date" required="required" name="date_naissance"/>
											</div>
										</div>
									</td>
									<td>
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" class="form-control" data-inputmask="'mask' : '(999) 99999999'" required="required" name="teltuteur"/>
											</div>
										</div>
									</td>
									<td>
								...
								<tr>
									<td>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:left;font-weight:bold;color:#000;">Niveau d'inscription
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
