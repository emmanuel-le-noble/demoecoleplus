...
<html lang="en">
<head>
    <link href="designnew.css" rel="stylesheet"/>
</head>
	<body>
	<?php
	if($idbulletin==0)
				...
				<tr>
					<td valign="top" colspan="4">
						<table width="100%" class="design" style="border-spacing:0;border-collapse:collapse;">
							...
							<tr>
								<td style="padding-left:5px;font-weight:bold;">Philosophie</td>
								<td>
									<table width="100%" style="border-spacing:0;border-collapse:collapse;border:1px solid #fff;">
										<tr>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteInt($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteDs($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td>
										</tr>
									</table>
								</td>
								<td align="center"><?php echo BulletinMoy_Class($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center"><?php echo BulletinNoteComp($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center"><?php echo BulletinMoy_Trimes($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center"><?php echo BulletinCoef($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td>
								<td align="center"><?php echo BulletinMoy_Pondere($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center"><?php echo BulletinRang($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinAppreciation($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="left">&nbsp;<?php echo BulletinProfesseur($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinSignature($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo);?></td>
							</tr>
							<tr>
								<td style="padding-left:5px;font-weight:bold;">Fran&ccedil;ais</td>
								<td>
									<table width="100%" style="border-spacing:0;border-collapse:collapse;border:1px solid #fff;">
										<tr>
							...
							<tr>
								<td style="padding-left:5px;font-weight:bold;">Allemand</td>
								<td>
									<table width="100%" style="border-spacing:0;border-collapse:collapse;border:1px solid #fff;">
										<tr>
							...
							<tr>
								<td style="padding-left:5px;font-weight:bold;">Espagnol</td>
								<td>
									<table width="100%" style="border-spacing:0;border-collapse:collapse;border:1px solid #fff;">
										<tr>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteInt($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteDs($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td>
										</tr>
									</table>
								</td>
								<td align="center"><?php echo BulletinMoy_Class($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center"><?php echo BulletinNoteComp($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center"><?php echo BulletinMoy_Trimes($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center"><?php echo BulletinCoef($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td>
								<td align="center"><?php echo BulletinMoy_Pondere($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center"><?php echo BulletinRang($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinAppreciation($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="left">&nbsp;<?php echo BulletinProfesseur($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinSignature($idanneescolaire,$idposition,$idsalle,$idelevesalle,25,$pdo);?></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="padding-left:5px;font-weight:bold;">Music</td>
								<td>
									<table width="100%" style="border-spacing:0;border-collapse:collapse;border:1px solid #fff;">
										<tr>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteInt($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td>
											<td align="center" style="border:1px solid #fff;width:50%;"><?php echo BulletinNoteDs($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td>
										</tr>
									</table>
								</td>
								<td align="center"><?php echo BulletinMoy_Class($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center"><?php echo BulletinNoteComp($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center"><?php echo BulletinMoy_Trimes($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center"><?php echo BulletinCoef($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td>
								<td align="center"><?php echo BulletinMoy_Pondere($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center"><?php echo BulletinRang($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinAppreciation($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="left">&nbsp;<?php echo BulletinProfesseur($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td><td align="center">&nbsp;<?php echo BulletinSignature($idanneescolaire,$idposition,$idsalle,$idelevesalle,28,$pdo);?></td>
							</tr><?php
							if(BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,3,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,23,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,24,$pdo)+
							...
							{
							//Calcul de la moyenne littéraire
							$moy_litteraire1 = (BulletinMoy_Pondere_($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo)+
												BulletinMoy_Pondere_($idanneescolaire,$idposition,$idsalle,$idelevesalle,3,$pdo)+
												BulletinMoy_Pondere_($idanneescolaire,$idposition,$idsalle,$idelevesalle,23,$pdo)+
												BulletinMoy_Pondere_($idanneescolaire,$idposition,$idsalle,$idelevesalle,24,$pdo)+
												...
												/
											   (BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,22,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,3,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,23,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,24,$pdo)+
												BulletinCoef_($idanneescolaire,$idposition,$idsalle,$idelevesalle,15,$pdo)+
							...
							//Calcul de la moyenne scientifique
